...
class BodyAnalysis extends BaseClient
{
    /**
     * 人体关键点识别接口
     *
     ...
     */
    public function bodyAnalysis(string $image, array $options = [])
    {
        $data          = array();
        $data['image'] = base64_encode($image);
        $data          = array_merge($data, $options);
        return $this->request('/rest/2.0/image-classify/v1/body_analysis', $data);
    }
     ...
     * @throws HttpException
     */
    public function bodyAttr(string $image, array $options = [])
    {
        $data          = array();
        $data['image'] = base64_encode($image);
        $data          = array_merge($data, $options);
        return $this->request('/rest/2.0/image-classify/v1/body_attr', $data);
    }
     ...
     * @throws HttpException
     */
    public function bodyNum(string $image, array $options = [])
    {
        $data          = array();
        $data['image'] = base64_encode($image);
        $data          = array_merge($data, $options);
        return $this->request('/rest/2.0/image-classify/v1/body_num', $data);
    }
     ...
     * @throws HttpException
     */
    public function gesture(string $image, array $options = [])
    {
        $data          = array();
        $data['image'] = base64_encode($image);
        $data          = array_merge($data, $options);
        return $this->request('/rest/2.0/image-classify/v1/gesture', $data);
    }
     ...
     * @throws HttpException
     */
    public function bodySeg(string $image, array $options = [])
    {
        $data          = array();
        $data['image'] = base64_encode($image);
        $data          = array_merge($data, $options);
        return $this->request('/rest/2.0/image-classify/v1/body_seg', $data);
    }
     ...
     * @throws HttpException
     */
    public function driverBehavior(string $image, array $options = [])
    {
        $data          = array();
        $data['image'] = base64_encode($image);
        $data          = array_merge($data, $options);
        return $this->request('/rest/2.0/image-classify/v1/driver_behavior', $data);
    }
     ...
     * @throws HttpException
     */
    public function bodyTracking(string $image, string $dynamic, array $options = [])
    {
        $data            = array();
        $data['image']   = base64_encode($image);
        $data['dynamic'] = $dynamic;
        $data            = array_merge($data, $options);
        return $this->request('/rest/2.0/image-classify/v1/body_tracking', $data);
    }
     ...
     * @throws HttpException
     */
    public function handAnalysis(string $image, array $options = [])
    {
        $data          = array();
        $data['image'] = base64_encode($image);
        $data          = array_merge($data, $options);
        return $this->request('/rest/2.0/image-classify/v1/hand_analysis', $data);
    }
}
